            ...
            function (a, b, c) {
                ...
                b.exports = function (a, b) {
                    ...
                    return !Modernizr.cssanimations || c
                        ? (d('.scroll-in-animation').removeClass(
                              'scroll-in-animation'
                          ),
                          void d('.scroll-animation').removeClass(
                              'scroll-animation'
                          ))
                        : (d('.safari i.scroll-in-animation').removeClass(
                              'scroll-in-animation'
                          ),
                          d('.safari i.scroll-animation').removeClass(
                              'scroll-animation'
                          ),
                          void a
                    ...
                    (this.windowTopPos = void 0),
                        ...
                        (this.calcPosition = function (a) {
                            ...
                            return {
                                ...
                                height: b,
                                visible:
                                    d < c.windowBottomPos && e > c.windowTopPos,
                            };
                        });
                };
            },
            ...
            function (a, b, c) {
                ...
                b.exports = new (function () {
                    var a =
                            ...
                            -1 !=
                                navigator.appVersion.indexOf('Windows NT 5.0'),
                ...
                b.exports = new (function () {
                    ...
                    (this.prepare = function (a) {
                        ...
                        (this.buildSizes = function (a) {
                            ...
                            d('.full-size, .half-size, .one-third-size').each(
                                function () {
                                    var a = d(this),
                                        b = parseInt(
                                            a
                        ...
                        g ||
                            e.each(function (a) {
                                ...
                                if (g.visible) {
                                    ...
                                    e.children('.bg:not(.static)').each(
                                        function () {
                                            var b = d(this).data();
                                            b.parallaxY = f.parallaxMargin(
                                                c,
                                                a,
                                                h
                                            );
                        ...
                        (this.colorClasses = (function () {
                            for (var b = '', c = 0; c < a.colors; c++) {
                                ...
                                b +=
                                    d +
                                    'colors-' +
                                    String.fromCharCode(65 + c).toLowerCase();
                            }
                            return b;
                        })());
                })();
            ...
            function (a, b, c) {
                ...
                b.exports = function (b) {
                    ...
                    function j(a, b, c, f, g, h, i) {
                        var j = d('<span class="getter"></span>').appendTo(
                            'body'
                        );
                        d(a).appendTo(j);
                        ...
                        if ((m.val(k), 'color' === c))
                            m.minicolors({
                                ...
                                defaultValue:
                                    d(this).attr('data-defaultValue') || '',
                                inline: 'true' === d(this).attr('data-inline'),
                                letterCase:
                                    d(this).attr('data-letterCase') ||
                                    'lowercase',
                                opacity: !1,
                                position:
                                    d(this).attr('data-position') || 'top left',
                                change: function (a, b) {
                                    e(), (B.lessVars[g] = a), l();
                                },
                                show: function () {
                    ...
                    function k() {
                        ...
                        u.change(function () {
                            d(
                                '.options .themes select option[value=custom]'
                            ).remove();
                            var a = d(this).val();
                            (d.cookie.json = !1),
                    ...
                    function m(a, b) {
                        less.render(
                            a,
                            {
                                ...
                                rootFilename:
                                    'styles/themes/theme-default.less',
                                relativeUrls: !1,
                ...
                $(function () {
                    !new (function () {
                        ...
                        function widgets($context) {
                            new ShowList($context, me),
                                ...
                                $context.find('a').click(function (a) {
                                    var b = $(this);
                                    b.data('toggle') ||
                                        navigate(this.href, this.hash, a, b);
                                }),
                                fluid.setup($context),
                                new Map($context),
                                ...
                                $context.find('video').each(function () {
                                    void 0 !== $(this).attr('muted') &&
                                        (this.muted = !0);
                                }),
                                $context
                                    .find('.open-overlay-window')
                                    .each(function () {
                                        var a = $(this),
                        ...
                        var Customize = require('./customize/customize.js'),
                            ...
                            isAndroid43minus = $('html').hasClass(
                ...
                b.exports = function (b) {
                    ...
                    b.find('.change-colors').each(function () {
                        for (
                            ...
                            var h =
                                'colors-' +
                                String.fromCharCode(65 + g).toLowerCase();
                            e.hasClass(h) &&
                                ((a = h),
                                f.each(function () {
                                    var b = d(this);
                    ...
                    a.click(function (a) {
                        ...
                        if (b.hasClass('ext-nav-toggle')) {
                            var c = b.data('target'),
                                ...
                                f = d(
                                    c +
                                        ',#top-nav a:not(.menu-toggle),.page-border a'
                                ),
                                g = function () {
                                    e.removeClass('show'),
                                        b.removeClass('show'),
                ...
                b.exports = function () {
                    ...
                    (this.state1H = i),
                        ...
                        f &&
                            (n.state1(),
                            g
                                .find('a:not(.dropdown-toggle)')
                                .click(function () {
                                    c
                                        .find('.navbar-collapse.in')
                                        .collapse('hide'),
                                        c
                                            .find('.menu-toggle.navbar-toggle')
                                            .removeClass('show');
                                }),
